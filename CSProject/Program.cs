...
namespace CSProject
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            int month = 0, year = 0; while (year == 0)
            {
            ...
            for (int i = 0; i < myStaff.Count; i++)
            {
                try
                {
                    ...
                    myStaff[i].HoursWorked = Convert.ToInt32(Console.ReadLine()); myStaff[i].CalculatePay();
    ...
    class PaySlip
    {
        ...
        public void GenerateSummary(List<Staff> myStaff)
        {
            var result = from f in myStaff
                         ...
                         select new { f.NameOfStaff, f.HoursWorked }; string path = "summary.txt"; using (StreamWriter sw = new StreamWriter(path))
            {
